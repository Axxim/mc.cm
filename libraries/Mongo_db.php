...
class Mongo_db
{
	...
	public function switch_db($database = '')
	{
		...
		try
		{
			...
			$this->_config_data['database'] = $database;
			$this->_connection_string();
			$this->_connect();
		}
	...
	*/
	...
	{		
		$this->_host = trim($this->_config_data['hostbase']);
		$this->_user = trim($this->_config_data['username']);
		$this->_pass = trim($this->_config_data['password']);
		$this->_dbname = trim($this->_config_data['database']);
		$this->_persist = $this->_config_data['persist'];
		$this->_persist_key = trim($this->_config_data['persist_key']);
		$this->_replica_set = $this->_config_data['replica_set'];
		$this->_query_safety = trim($this->_config_data['query_safety']);
		$dbhostflag = (bool) $this->_config_data['host_db_flag'];
